  ...
  const loadSettings = async () => {
    try {
      ...
      setSettings({
        ...savedSettings,
        databasePath,
        exportPath: localStorage.getItem('exportPath') || `${homePath}/Documents/Real Estate Exports`,
        isLoading: false
      })
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {settings.darkMode ? 'Easier on the eyes in low light' : 'Better visibility in bright environments'}
                    </p>
                  </div>
                </div>
                <Button
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                <div className="flex items-center gap-3">
                  <Info className={cn(
                    "w-5 h-5",
                    settings.includeRoomDetails ? "text-blue-600" : "text-gray-400"
                  )} />
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">
