...
export default function ProjectView() {
  ...
  const loadProjectData = async () => {
    ...
    try {
      ...
      let currentProject = cachedProjects?.find((p) => p.id === projectId) as
        | Project
        | undefined;
      ...
      if (!currentProject) {
        ...
        console.log(
          `[PROJECT_VIEW] Project ${id} not in cache, fetching from backend...`,
        );
              ...
              if (columns.length >= 7) {
                ...
                if (budgetMatch) {
                  ...
                  currentProject = {
                    ...
                    type: columns[5],
                    created: columns[6],
                    priority: columns[3].toLowerCase() as
                      | "high"
                      | "medium"
                      | "low"
                      | "urgent",
        ...
        const updatedProject: Project = {
          ...
          completion:
            currentProject.budget > 0
              ? Math.round((totalSpent / currentProject.budget) * 100)
              : 0,
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead>
                <tr>
                  ...
                  <th className="px-4 py-2 text-right text-gray-900 dark:text-white">
                    Amount
                  </th>
                  <th className="px-4 py-2 text-left text-gray-900 dark:text-white">
                    Notes
