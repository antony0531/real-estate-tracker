    ...
    try {
      ...
      setSettings({
        ...
        exportPath:
          ...
          "C:\\Users\\datac\\Documents\\Real Estate Exports",
        isLoading: false,
      });
    } catch (error) {
    ...
    <div className="p-6 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 pt-4">
          <button className="btn-primary px-6 py-2" onClick={saveSettings}>
            Save Settings
          </button>
          <button className="btn-outline px-6 py-2" onClick={resetToDefaults}>
            Reset to Defaults
          </button>
        </div>
      </div>
